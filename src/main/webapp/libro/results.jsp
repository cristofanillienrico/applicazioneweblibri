		    ...
		    <div class='card-body'>
		        ...
		        <div class='table-responsive'>
		            <table class='table table-striped ' >
		                ...
		                <tbody>
		                	<% List<Libro> listaArticoli = (List<Libro>)request.getAttribute("listaLibriAttribute");
		                		for(Libro item:listaArticoli){ %>
		                    <tr >
		                        <td><%=item.getId() %></td>
		                        ...
		                        <td>
									...
									<a class="btn btn-outline-danger btn-sm" href="PrepareRimuoviLibroServlet?idLibro=<%=item.getId() %>">Delete</a>
								</td>
		                    </tr>
		                    <% } %>
		                </tbody>
